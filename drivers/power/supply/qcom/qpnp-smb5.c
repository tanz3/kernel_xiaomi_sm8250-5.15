...
#if !defined(CONFIG_MACH_XIAOMI_MUNCH) || !defined(CONFIG_MACH_XIAOMI_PSYCHE)
...
#endif
#if defined(CONFIG_MACH_XIAOMI_DAGU) || defined(CONFIG_MACH_XIAOMI_PSYCHE)
		...
		union power_supply_propval *pval)
{
	...
	case POWER_SUPPLY_PROP_VOLTAGE_MAX:
		...
		pval->intval = get_effective_result(chg->fv_votable);
#else
...
#if defined(CONFIG_MACH_XIAOMI_MUNCH) || defined(CONFIG_MACH_XIAOMI_DAGU) || defined(CONFIG_MACH_XIAOMI_PSYCHE)
