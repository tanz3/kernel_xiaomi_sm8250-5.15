...
#define CVP_AON_WRAPPER_CVP_NOC_LPI_CONTROL	(CVP_AON_BASE_OFFS)
#define CVP_AON_WRAPPER_CVP_NOC_LPI_STATUS	(CVP_AON_BASE_OFFS + 0x4)
...
#define CVP_CC_MVS1_CBCR            (CVP_CC_BASE_OFFS + 0xDB4)
#define GCC_CLK_CTL_REG             (0x00100000) 
#define CVP_GCC_VIDEO_AXI1_CBCR     (0x0000B028)
#endif
